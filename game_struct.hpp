...
public:
  ...
  {
    if (bit_field.life != other.bit_field.life)
      return false;
    if (bit_field.hp != other.bit_field.hp)
      return false;
    if (bit_field.healing != other.bit_field.healing)
      return false;
    if (bit_field.attack != other.bit_field.attack)
      return false;
    if (bit_field.defence != other.bit_field.defence)
      return false;
    if (bit_field.agility != other.bit_field.agility)
      return false;
    if (name != other.name)
      return false;
    if (id != other.id)
